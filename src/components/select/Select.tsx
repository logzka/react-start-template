...
const CustomSelect = forwardRef(({
    ...
    return (
        ...
        >
            ...
            {showOptions && <CustomSelectOptionsStyled className="select__options">
                <CustomSelectOptionsListStyled className="select__options-list">
                    ...
                    : <CustomSelectOptionsListItemStyled className="select__options-list_item empty text-center">no items for select</CustomSelectOptionsListItemStyled>}
